...
\section{Даты}
\label{sec:org2a94c58}
\subsection{Консультация}
\label{sec:orgbb650e2}
\emph{2021-06-24 Thu}
\subsection{Экзамен}
\label{sec:org4a181ed}
\emph{2021-06-25 Fri}

\section{Видосы}
\label{sec:org4c43a3a}
\subsection{Интегралы}
\label{sec:orgab83067}
...
\label{sec:org8b59078}
\begin{enumerate}
\item Теорема 2.
\label{sec:org30246ad}
